...
//
//     final studentFeedbackListModel = studentFeedbackListModelFromMap(jsonString);

import 'dart:convert';

class StudentFeedbackListModel {
  ...
  factory StudentFeedbackListModel.fromJson(Map<String, dynamic> json) => StudentFeedbackListModel(
