...
import 'package:nedusoft/UI/staff/Attendance/edit_attendance/edit_att_view_model.dart';
...
class EditAttFormScreem extends StatelessWidget {
  const EditAttFormScreem({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(),
        viewModelBuilder: () => EditAttFormViewModel(),
              ...
              child: Scaffold(
                  ...
                  bottomNavigationBar: Padding(
                    ...
                    child: InkWell(
                      // onTap: ontap,
                      onTap: () async {
                        if (model.neededVariables.loginModel!.isSubject!) {
                          if (model.selectYearValue != null && model.selectSectionValue != null && model.selectClassValue != null && model.selectSubjectValue != null) {
                          ...
                          if (model.selectYearValue != null && model.selectSectionValue != null && model.selectClassValue != null) {
                            await model.navigateToSearchScreen();
                            log("message");
                          } else {
                            showCustomSnackbar(msg: "Please Select Required fields", type: SnackbarType.failure);
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              model.neededVariables.loginModel!.isSubject!
                                  ? Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                              ...
                              model.isBusy
                                  ? SizedBox()
                                  : model.getEnterAttendanceDropdownsModel?.isSession ?? false
                                      ? Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("Session", style: TextStyle(fontSize: 18, fontFamily: "Gilroy Medium", color: secondryColor)),
                                            SizedBox(
                                              height: 10,
                                            ),
                                            Container(
                                          ...
                                          children: [
                                            SizedBox(
                                              ...
                                              child: Column(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("From", style: TextStyle(fontSize: 18, fontFamily: "Gilroy Medium", color: secondryColor)),
                                                  Padding(
                                                    padding: const EdgeInsets.only(right: 12),
                                                    child: TextFormField(
                                                      readOnly: true,
                                                      onTap: () {
                                                        model.fromTimeFuc(context);
                                                      },
                                            ...
                                            SizedBox(
                                              ...
                                              child: Column(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("To", style: TextStyle(fontSize: 18, fontFamily: "Gilroy Medium", color: secondryColor)),
                                                  Padding(
                                                    padding: const EdgeInsets.only(right: 12),
                                                    child: TextFormField(
                                                      readOnly: true,
                                                      onTap: () {
                                                        model.toTimeFuc(context);
                                                      },
                                                      decoration: InputDecoration(
                                                          enabledBorder: UnderlineInputBorder(
                                                            borderSide: BorderSide(color: secondryColor),
