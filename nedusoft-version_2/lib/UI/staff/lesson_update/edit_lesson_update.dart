...
import 'edit_lesson_view_model.dart';

class StaffEditLessonUpdate extends StatelessWidget {
  int id;
  StaffEditLessonUpdate({required this.id});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(id),
        viewModelBuilder: () => StaffEditLessonViewModel(),
        builder: (context, model, child) => LoadingOverlay(
              ...
              opacity: 0.5,
              child: Scaffold(
                  appBar: PreferredSize(preferredSize: Size(MediaQuery.sizeOf(context).width, 60), child: CommonAppBar("Edit Lesson Update")),
