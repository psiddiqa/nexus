...
class StaffFeedBackHistoryScreen extends StatefulWidget {
  String subject;
  String assignId;
  List<Data> dataList;
  ...
  @override
  State<StaffFeedBackHistoryScreen> createState() => _StaffFeedBackHistoryScreenState();
}

class _StaffFeedBackHistoryScreenState extends State<StaffFeedBackHistoryScreen> {
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          InkWell(
                              onTap: () async {
                                if (c.file != null) {
                                  final file = await loadPdfFromNetwork(c.file ?? "");
                                  openPdf(file, c.file ?? "", c.fileName ?? "");
                                } else {
