...
import 'edit_chapter_view_model.dart';

class StaffEditChapter extends StatelessWidget {
  String? chapterId;
  StaffEditChapter({this.chapterId});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(chapterId!),
        viewModelBuilder: () => StaffEditChapterViewModel(),
        builder: (context, model, child) => LoadingOverlay(
              ...
              opacity: 0.5,
              child: Scaffold(
                  appBar: PreferredSize(preferredSize: Size(MediaQuery.sizeOf(context).width, 60), child: CommonAppBar("Edit Chapter")),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton(
                                ...
                                onChanged: (newvalue) {
                                  model.changeYearValue(newvalue as chapter.Year);
                                },
                                items: model.yearList.map((chapter.Year valueItem) {
                                  return DropdownMenuItem<chapter.Year>(
                                    value: valueItem,
