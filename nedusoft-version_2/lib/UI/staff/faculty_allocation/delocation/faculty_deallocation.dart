...
import 'faculty_deallocation_view_model.dart';

class StaffFacultyDeAllocationScreen extends StatelessWidget {
  const StaffFacultyDeAllocationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(),
        viewModelBuilder: () => StaffFacultyDeAllocationViewModel(),
