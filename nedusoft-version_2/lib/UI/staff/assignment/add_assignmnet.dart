...
import 'package:nedusoft/UI/staff/assignment/add_assignment_view_model.dart';
...
class StaffAddAssignment extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(),
        viewModelBuilder: () => StaffAssignmentViewModel(),
        builder: (context, model, child) => LoadingOverlay(
              ...
              opacity: 0.5,
              child: Scaffold(
                  appBar: PreferredSize(preferredSize: Size(MediaQuery.sizeOf(context).width, 60), child: CommonAppBar("Add Assignments")),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonRequiedTextWidget(text: "Chapters"),
                            SizedBox(
                              height: 10,
                            ),
                            Container(
