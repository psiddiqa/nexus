...
import 'package:nedusoft/UI/staff/marks/edit/edit_marks_view_model.dart';
import 'package:nedusoft/UI/staff/marks/marks_view_model.dart';
...
class StaffEditMarks extends StatelessWidget {
  const StaffEditMarks({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        onViewModelReady: (viewModel) => viewModel.init(),
        viewModelBuilder: () => StaffEditMarksViewModel(),
              ...
              child: Scaffold(
                  ...
                  bottomNavigationBar: Padding(
                    ...
                    child: InkWell(
                      // onTap: ontap,
                      onTap: () async {
                        if (model.selectYearValue != null && model.selectSectionValue != null && model.selectSubjectValue != null && model.selectClassValue != null && model.selectExamTypeValue != null && model.selectExamMasterValue != null) {
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonRequiedTextWidget(text: "Exam"),
                            SizedBox(
                              height: 10,
                            ),
                            Container(
                            ...
                            CommonRequiedTextWidget(text: "Exam Type"),
                            SizedBox(
                              height: 10,
                            ),
                            Container(
                              ...
                              child: DropdownButton(
                                ...
                                isExpanded: true,
                                underline: const SizedBox(),
                                value: model.selectExamTypeValue ?? model.examTypeList[0],
                                onChanged: (newvalue) {
                                  model.changeExamTypeValue(newvalue as SubjectList);
                                  // setState(() {
                                  //   selectarrive = newvalue as String?;
                                  // });
                                },
                                items: model.examTypeList.map((SubjectList valueItem) {
                                  return DropdownMenuItem<SubjectList>(
                                    value: valueItem,
                                    child: Text(valueItem.text!, style: TextStyle(color: BlackColor, fontFamily: 'Gilroy Medium', fontSize: 16)),
                                  );
