...
class StudentFeedBack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
        ...
        viewModelBuilder: () => StudentFeedbackViewModel(),
        builder: (context, model, child) => LoadingOverlay(
              ...
              opacity: 0.5,
              child: Scaffold(
                  appBar: PreferredSize(preferredSize: Size(MediaQuery.sizeOf(context).width, 60), child: CommonAppBar("My Feedback List")),
                                                    ...
                                                    Row(
                                                      children: [
                                                        SizedBox(
                                                          ...
                                                          child: Text(
                                                            model.feebbackListModel!.list![index].faculty ?? "faculty",
