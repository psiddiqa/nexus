...
import '../../models/lesson_update_model.dart';

class StudentLessonDetail extends StatefulWidget {
  LessonList model;
  StudentLessonDetail({
    required this.model,
    super.key,
  ...
  @override
  State<StudentLessonDetail> createState() => _StudentLessonDetailState();
}

class _StudentLessonDetailState extends State<StudentLessonDetail> {
              ...
              child: Column(
                children: [
                  ...
                  profile(
                      ...
                      addWidget: InkWell(
                        onTap: () async {
                          if (widget.model.filepath != null) {
                            final file = await loadPdfFromNetwork(widget.model.filepath ?? "");
                            openPdf(file, widget.model.filepath ?? "", widget.model.extension ?? "");
                          } else {
